...
public class Customer {
    private Long id, country_id, province_id, city_id, company_id;
    private String customer_code,    customer_description, 
            customer_address, 
            country_code, country_description, 
            city_code, city_description, province_code, province_description, 
            company_code, company_description,
            zip_code, 
            contact_person, 
            phone_number, 
            email;
